...
var d3_mouse_bug44083 =
  window.navigator && /WebKit/.test(window.navigator.userAgent) ? -1 : 0
...
var d3_timer_queueHead,
  ...
  d3_timer_timeout,
  d3_timer_frame =
    window[d3_vendorSymbol(window, 'requestAnimationFrame')] ||
    function (callback) {
...
d3.geo.distance = function (a, b) {
  ...
  return Math.atan2(
    Math.sqrt(
      (t = cosφ1 * sinΔλ) * t + (t = cosφ0 * sinφ1 - sinφ0 * cosφ1 * cosΔλ) * t,
    ),
  ...
  force.tick = function () {
    ...
    for (i = 0; i < m; ++i) {
      ...
      if ((l = x * x + y * y)) {
        ...
        y *= l
        t.x -=
          x * (k = s.weight + t.weight ? s.weight / (s.weight + t.weight) : 0.5)
        t.y -= y * k
        s.x += x * (k = 1 - k)
        s.y += y * k
      }
...
var d3_category20b = [
  ...
  9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372,
